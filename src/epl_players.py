...
if args.model=='rf':
	clf = RandomForestClassifier(random_state=42,n_estimators=130,class_weight='balanced')
	...
	model = Sequential()
	model.add(LSTM(100,input_shape=(1,1187),return_sequences=True,activation='relu' ))
